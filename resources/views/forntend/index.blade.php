...
<main class="content-2">
	...
	<section id="home" class="home d-flex align-items-center">
		...
		<div class="container" >
			...
			<!-- parallax layers -->
			<div class="parallax col-sm-12 cover_photo"  data-relative-input="true"  style="background-image: linear-gradient(rgba({{ $s_val -> color_top }}), rgba({{ $s_val -> color_bottom }})),url({{ URL::to('/')}}/media/home/{{ $s_val -> cover_photo }});  background-attachment: fixed ;
			background-position: center; max-width:1795px; max-height:945px">
				...
				<div class="col-md-4 col-sm-6 grid-item art">
					<a href="forntend/asset/images/works/1.svg" class="work-image">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="forntend/asset/images/works/1.svg" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6 grid-item branding">
					<a href="https://www.youtube.com/watch?v=qf9z4ulfmYw" class="work-video">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="forntend/asset/images/works/3.svg" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6 grid-item creative">
					<a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/240233494&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true&amp;visual=true" class="work-video">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="forntend/asset/images/works/4.svg" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6 grid-item art branding">
					<a href="#gallery-1" class="gallery-link">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="forntend/asset/images/works/5.svg" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
					<div id="gallery-1" class="gallery mfp-hide">
						<a href="forntend/asset/images/works/5.svg"></a>
						<a href="forntend/asset/images/works/4.svg"></a>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6 grid-item creative design">
					<a href="https://themeforest.net/user/pxlsolutions/portfolio" target="_blank">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="forntend/asset/images/works/6.svg" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
			...
			<div class="row">
				...
				<div class="col-md-4 pr-md-0 mt-md-4 mt-0">
					...
					<div class="price-item bg-white rounded shadow-dark text-center">
						<img src="forntend/asset/images/price-1.svg" alt="Regular" />
				...
				<div class="col-md-4 px-md-0 my-4 my-md-0">
					...
					<div class="price-item bg-white rounded shadow-dark text-center best">
						...
						<img src="forntend/asset/images/price-2.svg" alt="Premium" />
				...
				<div class="col-md-4 pl-md-0 mt-md-4 mt-0">
					<!-- price item -->
					<div class="price-item bg-white rounded shadow-dark text-center">
						<img src="forntend/asset/images/price-3.svg" alt="Ultimate" />
			...
			<div class="row">
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-1.svg" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-2.svg" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-3.svg" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-4.svg" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-5.svg" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-6.svg" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-7.svg" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="forntend/asset/images/client-8.svg" alt="client-name" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-4">
					...
					<div class="blog-item rounded bg-white shadow-dark wow fadeIn">
						<div class="thumb">
							...
							<a href="#">
								<img src="forntend/asset/images/blog/1.svg" alt="blog-title" />
							</a>
						</div>
						<div class="details">
				...
				<div class="col-md-4">
					...
					<div class="blog-item rounded bg-white shadow-dark wow fadeIn">
						<div class="thumb">
							...
							<a href="#">
								<img src="forntend/asset/images/blog/2.svg" alt="blog-title" />
							</a>
						</div>
						<div class="details">
				...
				<div class="col-md-4">
					...
					<div class="blog-item rounded bg-white shadow-dark wow fadeIn">
						<div class="thumb">
							...
							<a href="#">
								<img src="forntend/asset/images/blog/3.svg" alt="blog-title" />
							</a>
						</div>
						<div class="details">
